...
const events = [
  ...
  },
  {
    ...
    longDescription: "Experience the future of digital art at this exclusive NFT exhibition featuring works from renowned digital artists and emerging creators. The exhibition showcases diverse styles and mediums, from generative art to digital photography, all minted as NFTs. Attendees will have the opportunity to meet the artists, learn about their creative process, and even mint exclusive event NFTs. Light refreshments provided.",
    date: "2025-11-10",
    ...
    return (
      <div className="relative min-h-screen flex flex-col items-center justify-center p-6 bg-transparent overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-4xl font-bold text-white/30 mb-4">Event Not Found</h1>
          <button
      ...
      <div className="relative z-10 flex-1 pt-16 sm:pt-24 pb-24 max-w-3xl mx-auto w-full px-2 sm:px-4">
        ...
        <div className="space-y-4 sm:space-y-5 mb-8 sm:mb-12">
          <div className="flex items-start gap-3 sm:gap-4">
            <CalendarBlank size={20} weight="regular" className="text-white/40 mt-0.5 shrink-0" />
            <div>
              ...
              <p className="text-white/50 text-sm sm:text-base mt-0.5">{event.time}</p>
            </div>
          </div>

          <div className="flex items-start gap-3 sm:gap-4">
            <MapPin size={20} weight="regular" className="text-white/40 mt-0.5 shrink-0" />
            <div>
              <p className="text-white text-base sm:text-lg">{event.venue}</p>
              <p className="text-white/50 text-sm sm:text-base mt-0.5">{event.location}</p>
            </div>
          </div>

          <div className="flex items-start gap-3 sm:gap-4">
            <Users size={20} weight="regular" className="text-white/40 mt-0.5 shrink-0" />
            <div>
              <p className="text-white text-base sm:text-lg">{event.attendees} attending</p>
              <p className="text-white/50 text-sm sm:text-base mt-0.5">Hosted by {event.host}</p>
            </div>
          </div>
        </div>
